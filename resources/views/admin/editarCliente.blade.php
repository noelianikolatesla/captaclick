    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <select name="tipo_cliente" class="form-select @error('tipo_cliente') is-invalid @enderror" required>
                        <option value="física" {{ old('tipo_cliente', $cliente->tipo_cliente) == 'física' ? 'selected' : '' }}>Particular</option>
                        <option value="jurídica" {{ old('tipo_cliente', $cliente->tipo_cliente) == 'jurídica' ? 'selected' : '' }}>Empresa</option>
                    </select>
            ...
            <div class="mt-4 d-flex justify-content-center gap-3">
                ...
                <a href="{{ route('admin.clientes') }}" class="btn btn-volver">
                    Volver al listado
                </a>
            </div>
        </form>
