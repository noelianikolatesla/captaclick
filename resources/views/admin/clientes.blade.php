...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container mt-4">
            ...
            <!-- Encabezado y botón nuevo cliente -->
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-4 gap-2">
                <h2 class="mb-0 flex-grow-1">Clientes Registrados</h2>
                <a href="{{ route('clientes.create') }}" class="btn btn-success d-flex align-items-center gap-2 px-3 py-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-wrap gap-1">
                                    <a href="{{ route('clientes.showAdmin', $cliente->id) }}" class="btn btn-outline-primary btn-sm">Ver</a>
                                    <a href="{{ route('clientes.edit', $cliente->id) }}" class="btn btn-outline-warning btn-sm">Editar</a>
                                    <form action="{{ route('clientes.destroy', $cliente->id) }}" method="POST" class="d-inline" onsubmit="return confirm('¿Estás seguro de que quieres eliminar este cliente?');">
                                        @csrf
                                        @method('DELETE')
