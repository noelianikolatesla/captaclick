                        ...
                        <td>
                            <div class="d-flex flex-wrap gap-1">
                                @if($visita->acuerdo_generado)
                                    <a href="{{ route('visitas.verAcuerdoUser', $visita->id) }}" target="_blank" class="btn btn-outline-primary btn-sm">
                                        👁️ <span class="d-none d-md-inline">Ver</span>
                                    </a>
                                @else
                                    <form action="{{ route('visitas.generarAcuerdoUser', $visita->id) }}" target="_blank" method="POST">
                                        @csrf
                                ...
                                <a href="{{ route('visitas.editUser', $visita->id) }}" class="btn btn-outline-warning btn-sm">
                                    ✏️ <span class="d-none d-md-inline">Editar user</span>
                                </a>
